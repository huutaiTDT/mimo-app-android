...
public final class FragmentOnboardingBinding implements ViewBinding {
  ...
  private FragmentOnboardingBinding(@NonNull LinearLayout rootView, @NonNull ImageView imageView) {
  ...
  public static FragmentOnboardingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentOnboardingBinding((LinearLayout) rootView, imageView);
    }
