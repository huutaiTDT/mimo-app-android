...
import huutai.dev.meetmino.core.common.di.CoreModule_ProvideLoggerFactory;
import huutai.dev.meetmino.core.logging.Logger;
import huutai.dev.meetmino.di.NetworkModule_ProvideAuthServiceFactory;
import huutai.dev.meetmino.di.NetworkModule_ProvideChatBotServiceFactory;
import huutai.dev.meetmino.di.NetworkModule_ProvideHttpLoggingInterceptorFactory;
import huutai.dev.meetmino.di.NetworkModule_ProvideOkHttpClientFactory;
import huutai.dev.meetmino.di.NetworkModule_ProvideRetrofitFactory;
...
import huutai.dev.meetmino.view_model.AuthViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import huutai.dev.meetmino.view_model.AuthViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    AuthRepository authRepository() {
      return new AuthRepository(singletonCImpl.provideAuthServiceProvider.get());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // huutai.dev.meetmino.view_model.AuthViewModel
          return (T) new AuthViewModel(viewModelCImpl.authRepository(), singletonCImpl.userViewModelProvider.get());
  ...
  private static final class SingletonCImpl extends MyApplication_HiltComponents.SingletonC {
    ...
    Provider<Logger> provideLoggerProvider;
    ...
    Provider<ChatBotService> provideChatBotServiceProvider;
    ...
    ChatBotRepository chatBotRepository() {
      return new ChatBotRepository(provideChatBotServiceProvider.get());
    }

    @SuppressWarnings("unchecked")
    private void initialize() {
      this.provideLoggerProvider = DoubleCheck.provider(new SwitchingProvider<Logger>(singletonCImpl, 0));
      ...
      this.provideChatBotServiceProvider = DoubleCheck.provider(new SwitchingProvider<ChatBotService>(singletonCImpl, 2));
      this.chatViewModelProvider = DoubleCheck.provider(new SwitchingProvider<ChatViewModel>(singletonCImpl, 1));
      this.userViewModelProvider = DoubleCheck.provider(new SwitchingProvider<UserViewModel>(singletonCImpl, 6));
      this.provideAuthServiceProvider = DoubleCheck.provider(new SwitchingProvider<AuthService>(singletonCImpl, 7));
    }
    ...
    public ChatViewModel chatViewModel() {
      return chatViewModelProvider.get();
    }

    @Override
    public UserViewModel userViewModel() {
      return userViewModelProvider.get();
    }

    @CanIgnoreReturnValue
    private MyApplication injectMyApplication2(MyApplication instance) {
      MyApplication_MembersInjector.injectLogger(instance, provideLoggerProvider.get());
      return instance;
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // huutai.dev.meetmino.core.logging.Logger
          return (T) CoreModule_ProvideLoggerFactory.provideLogger();

          case 1: // huutai.dev.meetmino.view_model.ChatViewModel
          return (T) new ChatViewModel(singletonCImpl.chatBotRepository());

          case 2: // huutai.dev.meetmino.service.ChatBotService
          return (T) NetworkModule_ProvideChatBotServiceFactory.provideChatBotService(singletonCImpl.provideRetrofitProvider.get());
          ...
          case 6: // huutai.dev.meetmino.view_model.UserViewModel
          return (T) new UserViewModel();

          case 7: // huutai.dev.meetmino.service.AuthService
